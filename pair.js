            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'NAGIIP-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of NAGIIP-MD.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://chat.whatsapp.com/Cty5UEBzmbIBYtfSW6N3s2?mode=ac_t) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Nagiip King GitHub Repo](https://github.com/kingnagiip/)  

🚀 _Thanks for choosing NAGIIP-MD — Let the automation begin!_ ✨`;
